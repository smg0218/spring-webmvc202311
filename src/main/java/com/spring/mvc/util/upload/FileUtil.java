...
public class FileUtil {
     ...
     *              ex) /2023/12/29/randomName파일명.jpg
     */
    public static String uploadFile(MultipartFile file, String rootPath) {
        ...
        // full-path : D:/abc/upload/2024/01/02/randomName고양이.jpg
        // roothPath는 바뀔 수 있으므로 루트패스없이 저장
        // -> 2024/01/02/randomName고양이.jpg
        return fullPath.substring(rootPath.length());
    }

    /**
     * 루트 경로를 받아서 일자별로 폴더르 생성한 훈
     * 루트 경로 + 날짜폴더 경로를 반환
     *
